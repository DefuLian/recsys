...
R = train>0;
[M, N] = size(R);
[max_iter, reg_u, reg_i, Su,  Si, alpha, eta_u, eta_i] = process_options(varargin, 'max_iter', 10, 'reg_u', 0.01, 'reg_i', 0.01, ...
    'user_sim', sparse(M,M), 'item_sim', sparse(N,N), 'alpha', 10, 'eta_u', 0.01, 'eta_i', 0.01);
