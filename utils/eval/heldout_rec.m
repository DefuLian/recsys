...
[test, test_ratio, train_ratio, split_mode, times, rec_opt] = process_options(varargin, 'test', [], ...
    'test_ratio', 0.2, 'train_ratio', -1, 'split_mode', 'un', 'times', 1);
if train_ratio<0
...
if ~isempty(test)
    ...
    tic; evalout = scoring(train, test, P,  Q); elapsed(2) = toc;
